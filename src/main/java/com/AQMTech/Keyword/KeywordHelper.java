...
import com.API.requests.PostDemo;
...
public class KeywordHelper {
	 ...
	 */
	public void getPostDemo(XSSFWorkbook workbook,String sheetName,String scenarioID, ExcelOperation excelOperation) throws Exception {
		PostDemo demo = new PostDemo();
		demo.getDemo(workbook,sheetName,excelOperation,scenarioID);
	}
